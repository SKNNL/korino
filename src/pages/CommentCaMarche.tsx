...
const CommentCaMarche = () => {
  const schema = {
    ...
    "@type": "HowTo",
    "name": "Comment échanger des objets sur TradeIt",
    "description": "Guide étape par étape pour échanger vos objets sur TradeIt",
    "step": [
      {
        "@type": "HowToStep",
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-gradient-to-br from-primary/5 via-background to-accent/5 rounded-2xl p-8 space-y-6">
            <h2 className="text-2xl font-bold text-center">Pourquoi échanger sur TradeIt ?</h2>
